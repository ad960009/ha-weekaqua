...
# BLE GATT UUIDs (Primary & Transparant UART Series matching C# WPF)
SERVICE_UUID = "0000ffe0-0000-1000-8000-00805f9b34fb"
WRITE_CHAR_UUID = "0000ffe1-0000-1000-8000-00805f9b34fb"
NOTIFY_CHAR_UUID = "0000ffe3-0000-1000-8000-00805f9b34fb"

SERVICE_UUIDS = [
    "0000ffe0-0000-1000-8000-00805f9b34fb",
    "0000fff0-0000-1000-8000-00805f9b34fb",
    "0000ff60-0000-1000-8000-00805f9b34fb",
    "00010203-0405-0607-0809-0a0b0c0d1910",  # JDY-16 / Generic BLE
]
...
WRITE_CHAR_UUIDS = [
    ...
    "00010203-0405-0607-0809-0a0b0c0d1912",  # JDY Write
]

NOTIFY_CHAR_UUIDS = [
    "0000ffe3-0000-1000-8000-00805f9b34fb",
    "0000fff1-0000-1000-8000-00805f9b34fb",
    "0000ff62-0000-1000-8000-00805f9b34fb",
    "00010203-0405-0607-0809-0a0b0c0d1911",  # JDY Notify
]
